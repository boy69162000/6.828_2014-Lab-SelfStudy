...
.LM2:
	movl	%edi, %ebx
	.stabn	68,0,33,.LM3-.LFBB1
.LM3:
	xorl	%eax, %eax
	movl	$.LC0, %edi
	call	cprintf
	.stabn	68,0,34,.LM4-.LFBB1
.LM4:
	testl	%ebx, %ebx
	jle	.L2
...
.LM5:
	leal	-1(%rbx), %edi
	call	test_backtrace
	.stabn	68,0,38,.LM6-.LFBB1
.LM6:
	movl	%ebx, %esi
	movl	$.LC1, %edi
	xorl	%eax, %eax
	.stabn	68,0,39,.LM7-.LFBB1
.LM7:
	popq	%rbx
	.cfi_remember_state
	.cfi_def_cfa_offset 8
	.stabn	68,0,38,.LM8-.LFBB1
.LM8:
	jmp	cprintf
	.p2align 4,,10
	.p2align 3
.L2:
	.cfi_restore_state
	.stabn	68,0,37,.LM9-.LFBB1
.LM9:
	xorl	%esi, %esi
	xorl	%edi, %edi
	xorl	%edx, %edx
	call	mon_backtrace
	.stabn	68,0,38,.LM10-.LFBB1
.LM10:
	movl	%ebx, %esi
	movl	$.LC1, %edi
	xorl	%eax, %eax
	.stabn	68,0,39,.LM11-.LFBB1
.LM11:
	popq	%rbx
	.cfi_def_cfa_offset 8
	.stabn	68,0,38,.LM12-.LFBB1
.LM12:
	jmp	cprintf
	.cfi_endproc
.LFE0:
...
.LM16:
	...
	movl	$edata, %edi
	call	memset
	.stabn	68,0,53,.LM17-.LFBB2
.LM17:
	call	cons_init
	.stabn	68,0,66,.LM18-.LFBB2
.LM18:
	movl	$.LC2, %edi
	movl	$6828, %esi
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,69,.LM19-.LFBB2
.LM19:
	movl	$5, %edi
	call	test_backtrace
	.p2align 4,,10
...
.LM29:
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,101,.LM30-.LFBB3
.LM30:
	leaq	8(%rsp), %rsi
	movq	%rbx, %rdi
	call	vcprintf
	.stabn	68,0,102,.LM31-.LFBB3
.LM31:
	movl	$.LC4, %edi
	xorl	%eax, %eax
	call	cprintf
...
.LFB3:
	...
	movaps	%xmm7, 192(%rsp)
.L18:
	.stabn	68,0,117,.LM33-.LFBB4
.LM33:
	leaq	224(%rsp), %rax
	.stabn	68,0,118,.LM34-.LFBB4
.LM34:
	movl	%esi, %edx
	movq	%rdi, %rsi
	movl	$.LC5, %edi
	.stabn	68,0,117,.LM35-.LFBB4
.LM35:
	movq	%rax, 16(%rsp)
	leaq	32(%rsp), %rax
	movl	$24, 8(%rsp)
	movl	$48, 12(%rsp)
	movq	%rax, 24(%rsp)
	.stabn	68,0,118,.LM36-.LFBB4
.LM36:
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,119,.LM37-.LFBB4
.LM37:
	leaq	8(%rsp), %rsi
	movq	%rbx, %rdi
	call	vcprintf
	.stabn	68,0,120,.LM38-.LFBB4
.LM38:
	movl	$.LC4, %edi
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,122,.LM39-.LFBB4
.LM39:
	addq	$208, %rsp
	.cfi_def_cfa_offset 16
	popq	%rbx
